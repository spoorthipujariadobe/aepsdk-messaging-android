...
class CarouselContainerUI (
    private val template: CarouselContainerUITemplate,
    state: CarouselContainerUIState
) : BaseContainerUI<CarouselContainerUITemplate, CarouselContainerUIState>(template, state)